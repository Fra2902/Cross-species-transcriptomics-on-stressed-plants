...
for(sp in species) {
  ...
  coldata <- read.xlsx(here(paste0("Project/", sp, "/Data/metadata_filtered_3.xlsx")))
  counts_gene_level <- read.table(here(paste0("Project/", sp, "/Data/counts_gene_level_2.txt")))
  ...
  for (tissue in tissues) {
    ...
    norm_adj <- read.table(here(paste0("Project/", sp, "/Data/counts_gene_level_", tissue, "_normalised_adjusted.txt")))
