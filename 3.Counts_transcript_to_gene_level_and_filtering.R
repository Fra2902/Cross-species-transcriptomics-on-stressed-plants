...
for(sp in species) {
  ...
  counts <- read.delim(here(paste0("Project/", sp, "/Data/compiled_counts_table.txt")))
  
  tpm <- read.delim(here(paste0("Project/", sp, "/Data/compiled_tpm_table.txt")))
  ...
  write.table(counts_gene_level, here(paste0("Project/", sp, "/Data/counts_gene_level.txt")))
  
  write.table(tpm_gene_level, here(paste0("Project/", sp, "/Data/tpm_gene_level.txt")))
